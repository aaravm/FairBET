...
import Weel from './../components/roulette/weel/Weel';
import RouletteTable from '../components/roulette/table/Table';
import { Container, Row, Col, Image } from 'react-bootstrap';
import { GiDiamonds } from 'react-icons/gi';

import firstRow from '../components/roulette/table/rows/FirstRow.json';
import firstBorder from '../components/roulette/table/rows/FirstBorder.json';
import secondRow from '../components/roulette/table/rows/SecondRow.json';
import secondBorder from '../components/roulette/table/rows/SecondBorder.json';
import thirdRow from '../components/roulette/table/rows/ThirdRow.json';
import thirdBorder from '../components/roulette/table/rows/ThirdBorder.json';
import fourthRow from '../components/roulette/table/rows/FourthRow.json';
import fifthRow from '../components/roulette/table/rows/FifthRow.json';
